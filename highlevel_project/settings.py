"""
Django settings for highlevel_project project.
...
SECRET_KEY = 'django-insecure-n0i8v#ok*@ensi(y%o4)8w1mlscd$1fo*9k&=r8pu+rumg654='
...
ROOT_URLCONF = 'highlevel_project.urls'
...
WSGI_APPLICATION = 'highlevel_project.wsgi.application'
